...
public class App {
	// 1. Olvassuk be a fájlt egy olyan adatszerkezetbe, hogy a további feladatok megoldhatóak
	// legyenek!

	// 2. Írjuk ki az álláshirdetések adatait soronként! Paraméterként legyen megadható, hogy
	...
	// 8. Van –e olyan állás és ha igen melyek azok, ahol nem szükséges munkatapasztalat!

	// 9. Melyek azok az állások, amelyek több, mint 3 hete vannak fent a portálon?

	// 10. Melyik a legfrissebb állásajánlat?

	// 11. Átlagosan melyik pozícióban lehet keresni a legtöbbet (Eddigi legnehezebb alg.)?
